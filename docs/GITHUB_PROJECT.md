...
Not all of this belongs on a modern portfolio site, and the triage is the substance of this milestone rather than the mechanics.  The default disposition for anything that is dated, thin, or off-message is a lightly-maintained `archive/` area that keeps URLs alive without competing for attention; the qualifying exams are the clearest example of content that is genuinely useful to other people, genuinely not what this site is for, and should therefore be preserved but not featured.
