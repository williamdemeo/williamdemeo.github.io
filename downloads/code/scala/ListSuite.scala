...
class ListsSuite extends FunSuite {
  ...
  test("sum of a list with some negatives some positives"){
    assert(sum(List(-1,-1,-2,0,1))===(-3))
  }
  test("sum of a list with repeats"){
  ...
  test("max of a list with some negatives some positives"){
    assert(max(List(-1,-1,-2,0,1))===1)
  }
  test("max of a list with repeats"){
    assert(max(List(1,1,1))===1)
  }
  test("max of some negative integers with repeats"){
    assert(max(List(-1,-2,-3,-3))===(-1))
  }
